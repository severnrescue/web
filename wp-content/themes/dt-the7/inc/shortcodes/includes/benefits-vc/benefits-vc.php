			...
			if ( $this->atts['image_background'] ) {
				...
				if ( 'custom' == $this->atts['image_hover_background_paint'] ) {
					$stylesheet .= $this->get_stylesheet_rule(
						...
						.boxes-transparent-bg #page #{$shortcode_unique_id}.custom-hover-bg.icons-bg a.benefits-grid-ico:hover,
						.boxes-solid-bg #page #{$shortcode_unique_id}.custom-hover-bg.icons-bg a.benefits-grid-ico:hover,
						.style-ios #page .stripe.stripe-transparent-bg #{$shortcode_unique_id}.custom-hover-bg.icons-bg a.benefits-grid-ico:hover",
