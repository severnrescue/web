...
if ( 'vc_tour' === $this->shortcode ) {
	$output .= "\n\t\t\t" . '<div class="wpb_tour_next_prev_nav vc_clearfix"> <span class="wpb_prev_slide"><a href="#prev" title="' . __( 'Previous slide', 'the7mk2' ) . '">' . __( 'Previous slide', 'the7mk2' ) . '</a></span> <span class="wpb_next_slide"><a href="#next" title="' . __( 'Next slide', 'the7mk2' ) . '">' . __( 'Next slide', 'the7mk2' ) . '</a></span></div>';
}
