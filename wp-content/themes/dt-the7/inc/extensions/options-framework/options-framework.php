...
function optionsframework_get_menu_items() {
	...
	array_unshift( $menu_items, array( 'page_title' => _x( 'General', 'backend', 'the7mk2' ), 'menu_title' => _x( 'General', 'backend', 'the7mk2' ), 'main_title' => _x( 'Theme Options', 'backend', 'the7mk2' ) , 'menu_slug' => 'options-framework') );
