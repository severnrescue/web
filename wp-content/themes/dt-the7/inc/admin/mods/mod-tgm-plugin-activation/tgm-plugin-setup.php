...
if ( ! function_exists( 'presscore_get_required_plugins_list' ) ) :

	function presscore_get_required_plugins_list() {
		$plugins = include trailingslashit( PRESSCORE_PLUGINS_DIR ) . 'plugins.php';
		return $plugins ? $plugins : array();
	}
...
if ( ! function_exists( 'presscore_register_required_plugins' ) ) :
	...
	function presscore_register_required_plugins() {
		...
		$plugins = presscore_get_required_plugins_list();
