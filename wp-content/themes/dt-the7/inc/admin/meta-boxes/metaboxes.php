...
$DT_META_BOXES['dt_page_box-custom_header_logo'] = array(
	...
	'title' 	=> _x( 'Logo in header', 'backend metabox', 'the7mk2' ),
	...
	'fields' 	=> array(
		...
		array(
			'name'				=> _x( 'Logo', 'backend metabox', 'the7mk2' ),
			'id'               	=> "{$prefix}regular",
		...
		array(
			'name'				=> _x('High-DPI (retina) logo', 'backend metabox', 'the7mk2'),
			'id'               	=> "{$prefix}hd",
			'type'             	=> 'image_advanced_mk2',
			'max_file_uploads'	=> 1
		),
...
$DT_META_BOXES['dt_page_box-header_options'] = array(
	...
	'fields' 	=> array(
		...
		array(
			...
			'top_divider'	=> true,
			'options'		=> array(
				'normal'		=> array( _x('Normal', 'backend metabox', 'the7mk2'), array('regular.gif', 100, 60) ),
				'overlap'		=> array( _x("Overlapping (doesn't work with side header & Photo scroller)", 'backend metabox', 'the7mk2'), array('overl.gif', 100, 61) ),
				'transparent'	=> array( _x("Transparent (doesn't work with side header)", 'backend metabox', 'the7mk2'), array('transp.gif', 100, 60) ),
			),
			'hide_fields'	=> array(
...
$DT_META_BOXES['dt_page_box-slideshow_options'] = array(
	...
	'fields' 	=> array(
		...
		array(
			...
			'std'		=> 'porthole',
			'options'	=> array(
				'porthole' => array( _x('Porthole slider', 'backend metabox', 'the7mk2'), array('portholeslider.gif', 75, 50) ),
				// 'metro' => array( _x('Metro slider', 'backend metabox', 'the7mk2'), array('metro.png', 75, 50) ),
				'photo_scroller' => array( _x('Photo scroller', 'backend metabox', 'the7mk2'), array('photoscroller.gif', 75, 50) ),
				'3d' => array( _x('3D slideshow', 'backend metabox', 'the7mk2'), array('3dslider.gif', 75, 50) ),
				'revolution' => array( _x('Slider Revolution', 'backend metabox', 'the7mk2'), array('sliderrevolution.gif', 75, 50) ),
				'layer' => array( _x('LayerSlider', 'backend metabox', 'the7mk2'), array('layerslider.gif', 75, 50) ),
			),
			'hide_fields'	=> array(
		...
		array(
			...
			'desc'  		=> _x('if non selected, all slideshows will be displayed.', 'backend metabox', 'the7mk2') . ' <a href="' . esc_url( add_query_arg( 'post_type', 'dt_slideshow', get_admin_url() . 'edit.php' ) ) . '" target="_blank">' . _x('Edit slideshows', 'backend metabox', 'the7mk2') . '</a>',
...
/*
		...
		array(
			...
			'name'			=> _x('Number of slides in a row:', 'backend metabox', 'the7mk2'),
		...
		array(
			...
			'name'			=> _x('Number of slides in a column:', 'backend metabox', 'the7mk2'),
...
$DT_META_BOXES['dt_page_box-fancy_header_options'] = array(
	...
	'fields' 	=> array(
		...
		array(
			...
			'std'		=> 'center',
			'options'	=> array(
				'left'		=> array( _x('Left title + right breadcrumbs', 'backend metabox', 'the7mk2'), array('l-r.gif', 100, 60) ),
				'right'		=> array( _x('Right title + left breadcrumbs', 'backend metabox', 'the7mk2'), array('r-l.gif', 100, 60) ),
				'all_left'	=> array( _x('Left title + left breadcrumbs', 'backend metabox', 'the7mk2'), array('l-l.gif', 100, 60) ),
				'all_right'	=> array( _x('Right title + right breadcrumbs', 'backend metabox', 'the7mk2'), array('r-r.gif', 100, 60) ),
				'center'	=> array( _x('Centred title + centred breadcrumbs', 'backend metabox', 'the7mk2'), array('centre.gif', 100, 60) )
			)
		),
		...
		array(
			...
			'options'		=> array(
				'generic'	=> _x('Generic', 'backend metabox', 'the7mk2'),
