...
$DT_META_BOXES[] = array(
	...
	'fields' 	=> array(
		...
		Presscore_Meta_Box_Field_Template::get_as_array( 'radio yes no', array( 'id' => "{$prefix}show_filter", 'name' => _x( 'Show categories filter:', 'backend metabox', 'the7mk2' ), 'divider' => 'top' ) ),

		// Show name / date ordering
		Presscore_Meta_Box_Field_Template::get_as_array( 'radio yes no', array( 'id' => "{$prefix}show_orderby", 'name' => _x( 'Show name / date ordering:', 'backend metabox', 'the7mk2' ) ) ),

		// Show asc / desc ordering
		Presscore_Meta_Box_Field_Template::get_as_array( 'radio yes no', array( 'id' => "{$prefix}show_order", 'name' => _x( 'Show asc. / desc. ordering:', 'backend metabox', 'the7mk2' ) ) ),
...
$DT_META_BOXES[] = array(
	...
	'fields' 	=> array(
		...
		// Preview gallery
		array(
			'name'    		=> _x('For gallery post format:', 'backend metabox', 'the7mk2'),
			'id'      		=> "{$prefix}preview_style_gallery",
			'type'    		=> 'radio',
			'std'			=> 'standard_gallery',
			'options'		=> array(
				'standard_gallery'	=> _x('standard image gallery', 'backend metabox', 'the7mk2'),
				'hovered_gallery' 	=> _x('featured image with gallery hover', 'backend metabox', 'the7mk2'),
				'slideshow'			=> _x('slideshow', 'backend metabox', 'the7mk2'),
			),
			'before'		=> '<div class="dt_hr"></div><p><strong>' . _x('Post Preview Style', 'backend metabox', 'the7mk2') . '</strong></p>',
			'hide_fields'	=> array(
		...
		// Preview video
		array(
			'name'    	=> _x('For video post format:', 'backend metabox', 'the7mk2'),
			'id'      	=> "{$prefix}preview_style_video",
			'type'    	=> 'radio',
			'std'		=> 'image_play',
			'options'	=> array(
				'image' 			=> _x('image', 'backend metabox', 'the7mk2'),
				'image_play'		=> _x('image with "Play" icon', 'backend metabox', 'the7mk2'),
			),
		),
