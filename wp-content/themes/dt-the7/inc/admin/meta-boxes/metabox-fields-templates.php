...
Presscore_Meta_Box_Field_Template::add( 'description style values', array(
	'under_image'			=> array( _x( 'Under images', 'backend metabox', 'the7mk2' ), array( 'rollover-under.gif', 60, 40 ) ),
	'on_hoover_centered'	=> array( _x( 'On colored background', 'backend metabox', 'the7mk2' ), array( 'rollover-on-bg.gif', 60, 40 ) ),
	'on_dark_gradient'		=> array( _x( 'On dark gradient', 'backend metabox', 'the7mk2' ), array( 'rollover-on-grad.gif', 60, 40 ) ),
...
Presscore_Meta_Box_Field_Template::add( 'hover background color', array(
	...
	'options'	=> array(
		...
		'accent'	=> _x( 'Color (from Theme Options)', 'backend metabox', 'the7mk2' )
	)
) );
...
Presscore_Meta_Box_Field_Template::add( 'select pages', array(
	...
	'field_type'	=> 'select',
	'multiple'		=> false,
	'placeholder'	=> '— ' . _x( 'Choose page', 'backend metabox', 'the7mk2' ) . ' —'
) );
