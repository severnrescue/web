 ...
 */
$options[] = array(
		"page_title"	=> _x( "Images Styling &amp; Hovers", 'theme-options', 'the7mk2' ),
		"menu_title"	=> _x( "Images Styling &amp; Hovers", 'theme-options', 'the7mk2' ),
...
$options[] = array(	"name" => _x('Styling', 'theme-options', 'the7mk2'), "type" => "block_begin" );
	...
	$options["image_hover-default_icon"] = array(
		"name"		=> _x( "Default hover icon", "theme-options", 'the7mk2' ),
		"id"		=> "image_hover-default_icon",
		"std"		=> "white_icon",
		"type"		=> "radio",
		"options"	=> array(
			"none"			=> _x( 'No icon', 'theme-options', 'the7mk2' ),
			"white_icon"	=> _x( 'White icon', 'theme-options', 'the7mk2' )
		)
	);
 ...
 * Hover opacity.
 */
$options[] = array(	"name" => _x('Hover opacity', 'theme-options', 'the7mk2'), "type" => "block_begin" );
	...
	$options['image_hover-opacity'] = array(
		"desc"		=> '',
		"name"		=> _x( 'Background opacity for default hovers', 'theme-options', 'the7mk2' ),
	...
	$options['image_hover-with_icons_opacity'] = array(
		"desc"		=> '',
		"name"		=> _x( 'Background opacity for hovers with text and icons', 'theme-options', 'the7mk2' ),
