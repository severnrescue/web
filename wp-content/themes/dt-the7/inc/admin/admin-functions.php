...
function presscore_admin_notice() {
	...
	?>
	<div class="updated">
		<p><strong><?php echo _x( 'Failed to create customization .CSS file. To improve your site performance, please check whether ".../wp-content/uploads/" folder is created, and its CHMOD is set to 777.', 'backend css file creation error', 'the7mk2' ); ?></strong></p>
	</div>
	<?php
}
...
function presscore_add_slug_column_for_slideshow( $defaults ){
	$defaults['presscore-slideshow-slug'] = _x( 'Slug', 'backend', 'the7mk2' );
	return $defaults;
}
	...
	<div class="inline-edit-col-right">
		<fieldset>
			<div class="inline-edit-col">
				...
				<div class="inline-edit-group">
					<label class="alignleft">
						<span class="title"><?php _ex( 'Sidebar option', 'backend bulk edit', 'the7mk2' ); ?></span>
						<?php
					...
					<label class="alignright">
						<span class="title"><?php _ex( 'Widgetized footer', 'backend bulk edit', 'the7mk2' ); ?></span>
						<?php
						$show_wf = array(
							0	=> _x('Hide', 'backend bulk edit footer', 'the7mk2'),
							1	=> _x('Show', 'backend bulk edit footer', 'the7mk2'),
						);
						?>
			...
			<?php if ( function_exists('presscore_get_widgetareas_options') && $wa_list = presscore_get_widgetareas_options() ): ?>
				...
				<div class="inline-edit-group">
					<label class="alignleft">
						<span class="title"><?php _ex( 'Sidebar', 'backend bulk edit', 'the7mk2' ); ?></span>
					...
					<label class="alignright">
						<span class="title"><?php _ex( 'Footer', 'backend bulk edit', 'the7mk2' ); ?></span>
