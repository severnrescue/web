...
if ( ! function_exists( 'presscore_congif_populate_team_vars' ) ) :
	...
	function presscore_congif_populate_team_vars() {
		...
		$config->set( 'display', get_post_meta( $post_id, "{$prefix}display", true ) );
...
if ( ! function_exists( 'presscore_config_populate_header_options' ) ) :
	...
	function presscore_config_populate_header_options() {
		...
		$config->set( 'header.menu.hover.decoration.style', of_get_option( 'menu-decoration_style', '' ), '' );
...
if ( ! function_exists( 'presscore_config_get_theme_option' ) ) :
	...
	function presscore_config_get_theme_option() {
		...
		$config->set( 'template.content.boxes.background.mode', of_get_option( 'general-content_boxes_bg_mode', 'transparent' ) );
		$config->set( 'template.content.boxes.background.solid.color', of_get_option( 'general-content_boxes_solid_bg_color', '#ffffff' ) );
		...
		$config->set( 'template.icons.style', of_get_option( 'general-icons_style', 'light' ) );
