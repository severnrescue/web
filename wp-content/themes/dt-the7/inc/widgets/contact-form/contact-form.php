...
class Presscore_Inc_Widgets_ContactForm extends WP_Widget {
	...
	function __construct() {  
		...
		self::$fields_list = array(
			'name'		=> array( 'title' => _x('Name', 'widget', 'the7mk2'), 'defaults' => array( 'on' => true, 'required' => true ) ),
			'email'		=> array( 'title' => _x('E-mail', 'widget', 'the7mk2'), 'defaults' => array( 'on' => true, 'required' => true ) ),
			'telephone'	=> array( 'title' => _x('Telephone', 'widget', 'the7mk2'), 'defaults' => array( 'on' => false, 'required' => false ) ),
			'country'	=> array( 'title' => _x('Country', 'widget', 'the7mk2'), 'defaults' => array( 'on' => false, 'required' => false ) ),
			'city'		=> array( 'title' => _x('City', 'widget', 'the7mk2'), 'defaults' => array( 'on' => false, 'required' => false ) ),
			'company'	=> array( 'title' => _x('Company', 'widget', 'the7mk2'), 'defaults' => array( 'on' => false, 'required' => false ) ),
			'website'	=> array( 'title' => _x('Website', 'widget', 'the7mk2'), 'defaults' => array( 'on' => false, 'required' => false ) ),
			'message'	=> array( 'title' => _x('Message', 'widget', 'the7mk2'), 'defaults' => array( 'on' => true, 'required' => false ) ),
		);
	...
	function widget( $args, $instance ) {
		...
		if ( $fields_not_empty ) {
			...
			$button_title = !empty($instance['button_title']) ? $instance['button_title'] : _x('Submit', 'widget', 'the7mk2');
			...
			echo presscore_get_button_html( array(
				'href' => '#',
				'title' => _x('clear', 'widget', 'the7mk2'),
				'class' => 'clear-form',
				'atts' => ' rel="nofollow"'
			) );

			echo '<input class="assistive-text" type="submit" value="' . esc_attr( _x('submit', 'widget', 'the7mk2') ) . '">';
