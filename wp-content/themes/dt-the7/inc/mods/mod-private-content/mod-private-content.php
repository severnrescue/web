...
?>
    ...
    <p class="field-custom description description-wide pg_menu_restr_wrap">
        <label for="edit-menu-item-custom-<?php echo $item_id; ?>"><?php _e('Which PrivateContent user categories can see the page?', 'the7mk2') ?></label>
        ...
        <select name="menu-item-pg-hide-<?php echo $item_id; ?>[]" multiple="multiple" class="chzn-select pg_menu_select" data-placeholder="<?php _e('Select categories', 'the7mk2') ?> .." tabindex="2">
