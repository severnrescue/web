<?php
global $helper, $ioa_meta_data,$post,$super_options,$ioa_portfolio_slug,$portfolio_taxonomy;
$ioa_meta_data['item_per_rows'] = 3;
$ioa_meta_data['width'] = 353;
$ioa_meta_data['height'] = $super_options[SN.'_p3_height'];
$ioa_meta_data['column'] =  'one_third left';
