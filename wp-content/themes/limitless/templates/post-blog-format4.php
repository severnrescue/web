<?php
/**
 * The template used for generating blog template Format 4
 *
 * @package WordPress
...
if(isset( $ioa_options['dominant_color'] )) $dc = $ioa_options['dominant_color'];
        ...
        <li itemscope itemtype="http://schema.org/Article"  data-dbg='<?php echo $dbg; ?>' data-dc='<?php echo $dc; ?>' id="post-<?php the_ID(); ?>"  class=" clearfix <?php echo join(' ',get_post_class()); ?>   <?php $ioa_meta_data['i']++; if($ioa_meta_data['i']==1) echo 'first'; elseif($ioa_meta_data['i']==$ioa_meta_data['item_per_rows']) { echo 'last'; $ioa_meta_data['i']=0; } ?>">
          ...
          <?php if(isset($ioa_meta_data['blogmeta_enable']) && $ioa_meta_data['blogmeta_enable']!="false") : ?>
                  ...
                  <div class="clearfix post-content-area" item-prop='description'>
                ...
                <a href="" class="bottom-view-toggle down-diricon- ioa-front-icon"></a>
