<?php
/**
 * The Template for Archive Posts.
 *
 * @package WordPress
...
/**
 * Condition to check, if there is a custom taxonomy show different
 * template.
 */
if(is_tax()) :
	get_template_part('templates/custom-tax');
else :
...
$ioa_meta_data['sidebar'] = $super_options[SN.'_archive_sidebar'];
$ioa_meta_data['i'] = 0;
...
$cl = 'blog-format1-posts';
 switch($super_options[SN.'_archive_blog_layout'])
	 {
...
<div class="page-wrapper blog-template" >
